...
class Level {
  constructor(plan) {
    // trim the whitespace at start and at end of string and split the remaining string on newline characters and each line of plan is spread into an array, making array of characters
    let rows = plan
      .trim()
      .split("\n")
      .map((l) => [...l]);
...
// Size property is same for all player ,so we store it in on the prototype
